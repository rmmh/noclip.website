...
function extract(rom: Buffer): [object, Map<string, Buffer>] {
...
const [metadata, files] = extract(fs.readFileSync(romName));
...
console.log(`wrote metadata and ${files.size} files to ${outDir}`);
